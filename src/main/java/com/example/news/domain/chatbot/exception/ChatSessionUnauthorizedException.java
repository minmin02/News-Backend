...
public class ChatSessionUnauthorizedException extends CustomException {
    public ChatSessionUnauthorizedException() {
        super(ChatbotErrorCode.CHAT_SESSION_UNAUTHORIZED);
    }
}
